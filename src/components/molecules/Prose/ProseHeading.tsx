...
export default function ProseHeading({ content }: any) {
  return (
    <div
      className={
        `prose font-semibold text-2xl mx-auto mt-6  text-gray-800 ` +
        // h1
        ...
        // p
        `prose-p:mx-auto prose-p:mt-3 prose-p:text-xl prose-p:font-normal sm:prose-p:text-lg md:prose-p:mt-5 md:prose-p:text-2xl `
      }
    >
      {parse(content)}
    </div>
