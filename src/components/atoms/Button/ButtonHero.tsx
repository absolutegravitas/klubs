    ...
    <div key={id} className="py-3 mt-3 sm:mt-0 sm:ml-3 sm:flex-shrink-0">
      ...
      >
        <a
          ...
          className={`relative inline-flex items-center px-4 py-5 text-lg font-medium text-white border border-transparent rounded-xs shadow-xs hover:bg-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primaryColor-800`}
        >
